...
public class PlayerHandAction {
	...
	public PlayerHandAction(List<Card> handCards, List<Card> boardCards, BigDecimal potSize, String numPlayers, String position, BigDecimal avgChipCount, BigDecimal chipCount, String action) {
